      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/70 mb-12 max-w-3xl mx-auto">
            Founded in 2020, Paint It Forward is a community-driven organization dedicated to transforming neighborhoods through collaborative painting projects. We believe that a fresh coat of paint can do more than just beautify—it can bring people together, instill pride, and create lasting positive change.
          </p>
